...
# TODO: check whether we do the third part?
...
**Have you all successfully installed Rand RStudio?**
Otherwise, install Rand RStudio following our [setup guide](https://github.com/linusha/R-bootcamp-summer-2026/blob/main/IDS_Software_Setup.pdf) - or think about [updating](https://happygitwithr.com/install-r-rstudio.html) R, RStudio, and your installed packages. 
...
Rhas many data structures, the most important ones for now are:
